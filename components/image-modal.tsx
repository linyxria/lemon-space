            ...
            <div className="bg-card relative min-h-0 overflow-y-auto border-t p-4 pb-20 md:border-t-0 md:border-l md:p-6 md:pb-8">
              <div className="flex flex-col gap-6">
                <div className="space-y-1.5">
                  <h3 className="text-card-foreground max-w-70 truncate text-xl leading-tight font-semibold tracking-tight sm:max-w-md md:text-2xl">
                    {asset.title}
                  </h3>
                ...
                {relatedAssets && relatedAssets.length > 0 ? (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-muted-foreground text-sm font-semibold tracking-[0.12em] uppercase">
                        {t("continueExploring")}
                      </h4>
